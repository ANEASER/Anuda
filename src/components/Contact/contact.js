...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_xlc4jpn', 'template_tmqia9t', form.current, 'WGtjrNvKQVKyDE-en')
      .then((result) => {
  ...
  return (
    <div id="contact">
      <h1 className='contactPageTitle' style={{textAlign:'center'}}> <span style={{color:'cyan'}}>Contact</span> Me</h1>
